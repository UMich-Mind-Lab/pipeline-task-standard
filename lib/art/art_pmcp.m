function varargout = art_pmcp(varargin)
...
% mtwins processing!!
% ------------------------
z_thresh = 3;             %global signal threshold
mvmt_thresh = 1.0;          %absolute subject motion threshold
rotat_thresh = 0.0198;         %absolute subject rotation threshold
mvmt_diff_thresh = 1;     %scan-to-scan subject motion threshold
rotat_diff_thresh = 0.0198;    %scan-to-scan subject rotation threshold
